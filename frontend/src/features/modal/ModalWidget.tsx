  ...
  return (
    <>
      ...
      <div className="modal__content modal__container">
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Molestiae, pariatur quos?
          Aliquid ipsum voluptates doloribus, eum natus officiis! Voluptatibus quisquam facere
          dolore obcaecati nisi excepturi, officia aliquid eos? Culpa, recusandae?
        </p>
      </div>
